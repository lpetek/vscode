...
export const INLSExtensionScannerService = createDecorator<INLSExtensionScannerService>('NLSExtensionScannerService');

export class NLSExtensionScannerService extends Disposable implements INLSExtensionScannerService {
	constructor(
